// Edited by M Terry to be usable with just Underscore as a dependency. 2/2015
 ...
 * @final
 */
AffineTransform = function(opt_m00, opt_m10, opt_m01,
...
AffineTransform.prototype.setTransform = function(m00, m10, m01,
    m11, m02, m12) {
    if (!_.isNumber(m00) || !_.isNumber(m10) || !_.isNumber(m01) ||
        !_.isNumber(m11) || !_.isNumber(m02) || !_.isNumber(m12)) {
...
AffineTransform.prototype.transform = function(src, srcOff, dst,
    ...
    console.log('transform(' + src + ',' + srcOff + ',' + dst + ',' + dstOff + ',' + numPts + ')');
    console.log('src', src);
    console.log('srcOff', srcOff);
    console.log('dst', dstOff);
...
AffineTransform.prototype.isInvertible = function() {
    ...
    return _.isFinite(det) &&
        _.isFinite(this.m02_) &&
        _.isFinite(this.m12_) &&
        det != 0;
};
